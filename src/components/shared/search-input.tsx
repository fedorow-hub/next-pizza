      ...
      <div
        ...
        {products.length > 0 && (
          <div
            ...
            {products.map((product: any) => ( //TODO Проработать типизацию
              <Link href={`/product/${product.id}`} key={product.id} className="flex items-center gap-3 w-full px-3 py-2 hover:bg-primary/10 cursor-pointer">
